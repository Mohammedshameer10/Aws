...
var connection = mysql.createConnection({
  host     : 'hostname',    // Replace 'hostname' with your actual host name
  user     : 'username',    // Replace 'username' with your actual username
  password : 'password',    // Replace 'password' with your actual password
  database : 'userdata',    // Replace 'userdata' with your actual database name
  port     : 3306,          // Replace '3306' with your actual port number if different
  timeout  : 60000
});
